...
const MENU = [
  ...
  { section: "Administration", items: [
    ...
    { p: "/etablissement/fiche", ic: "ti-building-hospital", lbl: "Fiche étab.", col: "#1c5454" },
  ...
  return (
    <>
      <div className="topbar">
        ...
        {/* Alpha 0.35.0 : bouton visible qui déclenche la palette Ctrl+K via event custom.
            Le composant GlobalSearch reste monté dans layout.js (palette modale) — on évite le doublon. */}
        {auth && (
          <button
            className="tb-icon"
        ...
        {auth && <NotifBell structureId={auth.structureId} userId={auth.user?.id} />}
