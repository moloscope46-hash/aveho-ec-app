...
- Name: visual-regression.spec.js >> Visual regression — Notes HTML statiques >> Note 0.57.0 header matches baseline (Next 15 migration)
- Location: tests\e2e\visual-regression.spec.js:200:7
