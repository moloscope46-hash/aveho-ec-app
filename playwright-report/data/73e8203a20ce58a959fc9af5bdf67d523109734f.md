...
- Name: visual-regression.spec.js >> Visual regression — Sections /mentions-legales >> Mentions légales — section Éditeur (top 1100 px)
- Location: tests\e2e\visual-regression.spec.js:337:7
