...
- Name: visual-regression.spec.js >> Visual regression — Sections /mentions-legales >> Mentions légales — footer + contact (zone basse)
- Location: tests\e2e\visual-regression.spec.js:348:7
