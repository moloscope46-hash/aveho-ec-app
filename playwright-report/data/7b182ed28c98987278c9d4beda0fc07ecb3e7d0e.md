...
- Name: visual-regression.spec.js >> Visual regression — Viewports multiples >> Mobile petit (iPhone SE 375×667) >> /login iPhone SE
- Location: tests\e2e\visual-regression.spec.js:300:9
