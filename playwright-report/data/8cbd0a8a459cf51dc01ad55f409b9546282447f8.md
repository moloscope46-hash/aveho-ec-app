...
- Name: visual-regression.spec.js >> Visual regression — Viewports multiples >> Desktop large (1920×1080) >> /login desktop large
- Location: tests\e2e\visual-regression.spec.js:315:9
