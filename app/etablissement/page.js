          ...
          <>
                ...
                <div className="etab-filters">
                  {["bat", "etage", "service", "chambre", "patient", "materiel"].map((k) => (
                    <select key={k} value={st[k]} onChange={(e) => setFilter(k, e.target.value)}>
                      <option value="">{{ bat: "Bâtiment", etage: "Étage", service: "Service", chambre: "Chambre", patient: "Patient", materiel: "Matériel" }[k]}</option>
            ...
            <Panel style={{ marginTop: 18 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                <h2 style={{ margin: 0, fontSize: 17 }}>{{ patients: "Patients", materiels: "Matériel", di: "DI en cours" }[list]}</h2>
                <div className="seg">
...
function ListView({ list, rows, patients, materiels, dis, pName, matsOf, st, setFilter }) {
  ...
  if (list === "patients") {
    ...
    return <table><thead><tr><th>Patient</th><th>Chambre</th><th>Matériel</th><th>DI</th></tr></thead><tbody>
  ...
  if (list === "materiels") {
    ...
    return <table><thead><tr><th>Article</th><th>N° série</th><th>N° parc</th><th>N° lot</th><th>Patient</th><th>État</th></tr></thead><tbody>
  ...
  return <table><thead><tr><th>N°</th><th>Type</th><th>Urgence</th><th>Patient</th><th>Statut</th></tr></thead><tbody>
