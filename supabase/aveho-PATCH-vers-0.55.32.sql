-- ============================================================
--  AVEHO EC — Patch 0.55.32 (hotfix de 0.55.31)
--  Fix : migration robuste face à un schéma `etablissements` variable
--  (la colonne cp/latitude/longitude peut ne pas exister selon clients)
--  - Migration via jsonb pour tolérer les colonnes manquantes
--  - Vue v_etablissements_all construite dynamiquement
--  - RPC convert_etab_to_partner via jsonb
--  100% idempotent. Remplace le SQL 0.55.31 (peut être rejoué).
-- ============================================================
