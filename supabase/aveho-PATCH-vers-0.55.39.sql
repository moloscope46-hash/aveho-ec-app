...
-- Note 0.55.40 : l'index sur date_trunc('month', created_at) a été retiré
-- car PostgreSQL refuse les fonctions non-IMMUTABLE dans les index expressions.
-- L'index sur created_at desc suffit pour le filtre "where created_at >= date_trunc('month', now())".
