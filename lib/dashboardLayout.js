...
export const DEFAULT_ORDER = ["atraiter", "kpis", "raccourcis", "dernieres", "notifs"];
export const DEFAULT_ACTIVE = { atraiter: true, kpis: true, raccourcis: true, dernieres: true, notifs: true };
