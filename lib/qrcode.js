...
async function loadQR() {
  ...
  _qrPromise = new Promise((resolve, reject) => {
    ...
    // 0.57.37 : SRI pour qrcode-generator@1.4.4 (à recalculer si upgrade)
    s.integrity = "sha384-lQXOAyZwHXE55JFyrOMB7nY2Wv+m5ZWNtJcHrd1rceRQXAYNLak8ukN5TjBTcIwz";
    s.crossOrigin = "anonymous";  // requis pour SRI cross-origin
    s.async = true;
    s.onload = () => resolve(window.qrcode);
    s.onerror = () => reject(new Error("Impossible de charger qrcode-generator (CDN down ou SRI mismatch)"));
