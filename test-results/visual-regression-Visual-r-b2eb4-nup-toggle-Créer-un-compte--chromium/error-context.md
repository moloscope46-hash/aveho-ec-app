...
- Name: visual-regression.spec.js >> Visual regression — Login states >> Login mode signup (toggle Créer un compte)
- Location: tests\e2e\visual-regression.spec.js:232:7
