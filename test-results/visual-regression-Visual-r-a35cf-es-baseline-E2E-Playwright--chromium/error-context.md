...
- Name: visual-regression.spec.js >> Visual regression — Notes HTML statiques >> Note 0.57.12 header matches baseline (E2E Playwright)
- Location: tests\e2e\visual-regression.spec.js:210:7
