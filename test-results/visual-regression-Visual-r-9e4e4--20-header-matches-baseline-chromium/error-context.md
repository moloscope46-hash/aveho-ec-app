...
- Name: visual-regression.spec.js >> Visual regression — Notes HTML statiques >> Note 0.56.20 header matches baseline
- Location: tests\e2e\visual-regression.spec.js:190:7
