...
- Name: visual-regression.spec.js >> Visual regression — Viewports multiples >> Tablette iPad (1024×768) >> /login tablette landscape
- Location: tests\e2e\visual-regression.spec.js:275:9
