...
- Name: materiel-articles-scan.spec.js >> 0.58.75 - Page /transferts refondue (workflow multi-source) >> Route /transferts accessible (200)
- Location: tests\e2e\materiel-articles-scan.spec.js:323:7
